...
1.  **🥉 Bronze (The Loading Dock)**: The delivery truck dumps crates of raw tomatoes, dirty potatoes, and whole fish.
    *   *State*: Messy, packaging included, unwashed. **(Raw Data)**
2.  **🥈 Silver (The Prep Station)**: Chefs wash the vegetables, fillet the fish, and chop onions. Everything is organized into containers.
    *   *State*: Clean, consistent, usable, but not a meal yet. **(Cleaned Data)**
3.  **🥇 Gold (The Pass)**: The Line Cook assembles the ingredients into a specific dish (e.g., "Grilled Salmon with Veggies").
...
## 🔬 Deep Dive: CDC & The MERGE Command
